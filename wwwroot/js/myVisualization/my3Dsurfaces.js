...
function set3DContent(content, object) {
    ...
    filePath = filePath + "3DVisualizer\\";
    ...
    function init() {
        ...
        container_name = '3D_content_canvas';
        ...
        controls.noZoom = dimension_properties.dimension3D.noZoom;
        controls.noPan = dimension_properties.dimension3D.noPan;
        controls.noRotate = dimension_properties.dimension3D.noRotate;
    ...
    function loadModel(colorMap, numberOfColors, legendLayout) {
        ...
        loader.load(filePath + content + ".json", function (color_geometry) {
            ...
            //loaderVTK.load(filePath + object + '.txt', function (obtained_geometry) {
                ...
                var material = new THREE.MeshLambertMaterial({ color: 0xffffff, side: THREE.DoubleSide, vertexColors: THREE.VertexColors});
